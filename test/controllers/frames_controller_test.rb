...
class FramesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create frame" do
    assert_difference('Frame.count') do
      post frames_url, params: { frame: { game_id: @frame.game_id, score: @frame.score, try1: @frame.try1, try2: @frame.try2, turn: @frame.turn, user_id: @frame.user_id } }
    end
  ...
  test "should update frame" do
    patch frame_url(@frame), params: { frame: { game_id: @frame.game_id, score: @frame.score, try1: @frame.try1, try2: @frame.try2, turn: @frame.turn, user_id: @frame.user_id } }
